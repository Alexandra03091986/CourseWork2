...
@pytest.fixture
def json_file_worker_init():
    return [
        {
            "name": "Финансовый директор (CFO)",
            "salary": 400000,
            "city": "Москва",
            "requirements": "Команда проекта имеет успешный практический опыт реализации масштабных проектов в горнолыжно-туристической отрасли, в нашей команде работают профессионалы, знающие свое...",
        ...
        },
        {
            ...
            "salary": 86000,
            "city": "Россия",
            "requirements": "Рассматриваем кандидатов без опыта работы, если вы готовы обучаться и развиваться. Приветствуется опыт работы с людьми, сфере обслуживания, продажах; на...",
