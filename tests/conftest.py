...
def vacancies_for_filter():
    return [
        Vacancy("Водитель легкового автомобиля для руководителя", 80000,"Тюмень","Не менее 3-х лет работы водителем руководителя. Открытая категория В. Без фото резюме НЕ рассматриваются. Опыт работы с руководителем...","https://hh.ru/vacancy/124985030"),
        Vacancy("Специалист по кадрам", 3000, "Минск", "Личные качества: Стрессоустойчивость, коммуникабельность, ответственность.", "https://hh.ru/vacancy/125033362"),
        Vacancy("Администратор", 280000, "Алматы", "Навыки управления коллективом. Ответственность, коммуникабельность, стрессоустойчивость. Готовность работать в условиях многозадачности.", "https://hh.ru/vacancy/124464875")
    ]